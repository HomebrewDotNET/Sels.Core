...
namespace Sels.Core.FileSystem.Test.Templates.FileSizes
{
    public class FileSizeTests
    {
        ...
        public void FileSize_Equals_CorrectComparisonResultIsReturned(long bytes, Type fileSizeType, long otherBytes, Type otherFileSizeType, bool expected)
        {
            // Arrange
            ...
            // Act
            var result = fileSize.Equals(otherFileSize);
        ...
        {
            // Arrange
            var decimalSize = size.ChangeType<decimal>();
        ...
        [Test]
        public void FileSize_EqualOperator_CorrectComparisonResultIsReturnedWhenCheckingForNull()
        {
            // Arrange
            FileSize? size = null;
        ...
        [Test]
        public void FileSize_NotEqualOperator_CorrectComparisonResultIsReturnedWhenCheckingForNull()
        {
            // Arrange
            FileSize? size = null;
