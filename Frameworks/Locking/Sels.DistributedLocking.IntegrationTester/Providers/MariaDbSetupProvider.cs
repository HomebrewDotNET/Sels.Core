...
namespace Sels.DistributedLocking.IntegrationTester.Providers
{
    ...
    public class MariaDbSetupProvider : MySqlSetupProvider
    {
        ...
        /// <inheritdoc/>
        protected override ServiceProvider BuildProvider(IServiceCollection services) => services.AddMySqlLockingProvider(x => x.ConfigureDeployment(c => c.IgnoreMigrationExceptions = false).UseMariaDb()).BuildServiceProvider();
    }
}
