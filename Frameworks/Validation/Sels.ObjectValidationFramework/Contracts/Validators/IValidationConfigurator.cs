...
namespace Sels.ObjectValidationFramework.Contracts.Validators
{
    ...
    public interface IValidationConfigurator<TEntity, TError>
    {
        ...
        IValidationRuleConfigurator<TEntity, TError, NullValidationInfo, TEntity> ForSource();
        ...
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, NullValidationInfo, TValue> ForSource<TValue>(Func<TEntity, TValue> valueSelector);
        ...
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, PropertyValidationInfo, TPropertyValue> ForProperty<TPropertyValue>(Expression<Func<TEntity, TPropertyValue>> property);
        ...
        /// <typeparam name="TValue">Type of value to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, PropertyValidationInfo, TValue> ForProperty<TPropertyValue, TValue>(Expression<Func<TEntity, TPropertyValue>> property, Func<TPropertyValue, TValue> valueSelector);
        ...
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, CollectionPropertyValidationInfo, TElement> ForElements<TElement>(Expression<Func<TEntity, IEnumerable<TElement>>> property);
        ...
        /// <typeparam name="TValue">Type of value to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, CollectionPropertyValidationInfo, TValue> ForElements<TElement, TValue>(Expression<Func<TEntity, IEnumerable<TElement>>> property, Func<TElement, TValue> valueSelector);
