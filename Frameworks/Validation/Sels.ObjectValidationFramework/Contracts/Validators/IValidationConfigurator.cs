...
namespace Sels.ObjectValidationFramework.Contracts.Validators
{
    ...
    public interface IValidationConfigurator<TEntity, TError>
    {
        ...
        /// <param name="configurator">Configurator for creating validation rules</param>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationConfigurator<TEntity, TError> ValidateWhen<TContext>(Predicate<IValidationRuleContext<TEntity, TContext>> condition, Action<IValidationConfigurator<TEntity, TContext, TError>> configurator);
        /// <summary>
    ...
    /// <summary>
    /// Configurator for creating validation rules for objects of type <typeparamref name="TEntity"/> where all rules use a context of type <typeparamref name="TContext"/>.
    /// </summary>
    /// <typeparam name="TEntity">Type of object to create validation rules for</typeparam>
    ...
    public interface IValidationConfigurator<TEntity, TContext, TError>
    {
        ...
        /// <param name="settings">Extra settings for the rule</param>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, NullValidationInfo, TContext, TEntity> ForSource(RuleSettings settings = RuleSettings.None);
        ...
        /// <typeparam name="TValue">Type of value to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, NullValidationInfo, TContext, TValue> ForSource<TValue>(Func<TEntity, TValue> valueSelector, RuleSettings settings = RuleSettings.None);
        ...
        /// <typeparam name="TPropertyValue">Type of property to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, PropertyValidationInfo, TContext, TPropertyValue> ForProperty<TPropertyValue>(Expression<Func<TEntity, TPropertyValue>> property, RuleSettings settings = RuleSettings.None);
        ...
        /// <typeparam name="TValue">Type of value to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, PropertyValidationInfo, TContext, TValue> ForProperty<TPropertyValue, TValue>(Expression<Func<TEntity, TPropertyValue>> property, Func<TPropertyValue, TValue> valueSelector, RuleSettings settings = RuleSettings.None);
        ...
        /// <typeparam name="TElement">Type of element to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, CollectionPropertyValidationInfo, TContext, TElement> ForElements<TElement>(Expression<Func<TEntity, IEnumerable<TElement>>> property, RuleSettings settings = RuleSettings.None);
        ...
        /// <typeparam name="TValue">Type of value to validate</typeparam>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationRuleConfigurator<TEntity, TError, CollectionPropertyValidationInfo, TContext, TValue> ForElements<TElement, TValue>(Expression<Func<TEntity, IEnumerable<TElement>>> property, Func<TElement, TValue> valueSelector, RuleSettings settings = RuleSettings.None);
        ...
        /// <param name="configurator">Configurator for creating validation rules</param>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationConfigurator<TEntity, TContext, TError> ValidateWhen<TNewContext>(Predicate<IValidationRuleContext<TEntity, TNewContext>> condition, Action<IValidationConfigurator<TEntity, TNewContext, TError>> configurator) where TNewContext : TContext;
        /// <summary>
        /// All validation rules created fter calling this method will only be executed when <paramref name="condition"/> passes.
        /// </summary>
        /// <param name="condition">Delegate that checks if validation rules can be executed</param>
        /// <returns>Configurator for creating validation rules</returns>
        IValidationConfigurator<TEntity, TContext, TError> ValidateWhen(Predicate<IValidationRuleContext<TEntity, TContext>> condition);
        /// <summary>
