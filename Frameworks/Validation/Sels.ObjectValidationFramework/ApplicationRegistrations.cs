...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class ApplicationRegistrations
    {
        ...
        public static IServiceCollection RegisterAsyncValidator<TEntity, TError, TProfile>(this IServiceCollection services, ServiceScope scope = ServiceScope.Scoped, bool contextIsRequired = false, bool registerProfile = true, Func<IServiceProvider, IEnumerable<ILogger>> loggerFactory = null) where TProfile : ValidationProfile<TError>
        {
            ...
            return services.RegisterAsyncValidatorWithContext<TEntity, TError, object, TProfile>(scope, contextIsRequired, registerProfile, loggerFactory);
        }
            ...
            where TProfileTwo : ValidationProfile<TError>
        {
            ...
            return services.RegisterAsyncValidatorWithContext<TEntity, TError, object, TProfileOne, TProfileTwo>(scope, contextIsRequired, registerProfile, loggerFactory);
        }
            ...
            where TProfileThree : ValidationProfile<TError>
        {
            ...
            return services.RegisterAsyncValidatorWithContext<TEntity, TError, object, TProfileOne, TProfileTwo, TProfileThree>(scope, contextIsRequired, registerProfile, loggerFactory);
        }
            ...
            where TProfileFour : ValidationProfile<TError>
        {
            ...
            return services.RegisterAsyncValidatorWithContext<TEntity, TError, object, TProfileOne, TProfileTwo, TProfileThree, TProfileFour>(scope, contextIsRequired, registerProfile, loggerFactory);
        }
            ...
            where TProfileFive : ValidationProfile<TError>
        {
            ...
            return services.RegisterAsyncValidatorWithContext<TEntity, TError, object, TProfileOne, TProfileTwo, TProfileThree, TProfileFour, TProfileFive>(scope, contextIsRequired, registerProfile, loggerFactory);
        }
        #endregion
        #endregion
    }
