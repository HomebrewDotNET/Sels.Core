...
namespace Sels.Core.Command.Linux.Attributes
{
    ...
    public class CommandArgument : ObjectArgument
    {
        ...
        public CommandArgument(int order = LinuxCommandConstants.DefaultLinuxArgumentOrder, bool required = false) : base(Selector.Method, nameof(ICommand.BuildCommand), order: order, required: required)
        {
