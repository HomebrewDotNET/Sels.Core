...
namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class IServiceCollectionExtensions
    {
        ...
        public static IServiceCollection Register(this IServiceCollection services, Type serviceType, Type implementationType, ServiceLifetime scope = ServiceLifetime.Scoped) 
        {
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register<TService, TImplementation>(this IServiceCollection services, ServiceLifetime scope = ServiceLifetime.Scoped) where TImplementation : class, TService
        {
            services.ValidateArgument(nameof(services));
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register(this IServiceCollection services, Type serviceType, ServiceLifetime scope = ServiceLifetime.Scoped)
        {
            services.ValidateArgument(nameof(services));
            serviceType.ValidateArgument(nameof(serviceType));
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register<TService>(this IServiceCollection services, ServiceLifetime scope = ServiceLifetime.Scoped) where TService : class
        {
            services.ValidateArgument(nameof(services));
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register(this IServiceCollection services, Type serviceType, Func<IServiceProvider, object> implementationFactory, ServiceLifetime scope = ServiceLifetime.Scoped)
        {
            services.ValidateArgument(nameof(services));
            serviceType.ValidateArgument(nameof(serviceType));
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register<TService, TImplementation>(this IServiceCollection services, Func<IServiceProvider, TImplementation> implementationFactory, ServiceLifetime scope = ServiceLifetime.Scoped) where TImplementation : class, TService
        {
            services.ValidateArgument(nameof(services));
            implementationFactory.ValidateArgument(nameof(implementationFactory));
        ...
        /// <param name="scope">Which scope to use for the service</param>
        /// <returns>Self</returns>
        public static IServiceCollection Register<TService>(this IServiceCollection services, Func<IServiceProvider, TService> serviceFactory, ServiceLifetime scope = ServiceLifetime.Scoped) where TService : class
        {
            services.ValidateArgument(nameof(services));
