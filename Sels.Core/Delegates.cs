...
namespace Sels.Core
{
    ...
    public static class Delegates
    {
        ...
        /// <returns>Whether or not this condition passes</returns>
        public delegate bool Condition<T>(T arg);
        ...
        /// <returns>Whether or not this condition passes</returns>
        public delegate bool Condition<T1, T2, T3, T4>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);
        ...
        public static class Async
        {
            ...
            public delegate Task<bool> AsyncPredicate<T>(T arg);
            #endregion
            ...
            public delegate Task<bool> AsyncCondition<T>(T arg);

            /// <inheritdoc cref="Condition{T1, T2}"/>
            public delegate Task<bool> AsyncCondition<T1, T2>(T1 arg1, T2 arg2);

            /// <inheritdoc cref="Condition{T1, T2, T3}"/>
            public delegate Task<bool> AsyncCondition<T1, T2, T3>(T1 arg1, T2 arg2, T3 arg3);

            /// <inheritdoc cref="Condition{T1, T2, T3, T4}"/>
            public delegate Task<bool> AsyncCondition<T1, T2, T3, T4>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);

            /// <inheritdoc cref="Condition{T1, T2, T3, T4, T5}"/>
            public delegate Task<bool> AsyncCondition<T1, T2, T3, T4, T5>(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
            #endregion
            ...
            public delegate Task<TResult> Func<TResult>();

            /// <inheritdoc cref="Func{T, TResult}"/>
            public delegate Task<TResult> Func<T, TResult>(T arg);

            /// <inheritdoc cref="Func{T1, T2, TResult}"/>
            public delegate Task<TResult> Func<T1, T2, TResult>(T1 arg1, T2 arg2);

            /// <inheritdoc cref="Func{T1, T2, T3, TResult}"/>
            public delegate Task<TResult> Func<T1, T2, T3, TResult>(T1 arg1, T2 arg2, T3 arg3);

            /// <inheritdoc cref="Func{T1, T2, T3, T4, TResult}"/>
            public delegate Task<TResult> Func<T1, T2, T3, T4, TResult>(T1 arg1, T2 arg2, T3 arg3, T4 arg4);

            /// <inheritdoc cref="Func{T1, T2, T3, T4, T5, TResult}"/>
            public delegate Task<TResult> Func<T1, T2, T3, T4, T5, TResult>(T1 arg1, T2 arg2, T3 arg3, T4 arg4, T5 arg5);
            #endregion
        }
    }
}
