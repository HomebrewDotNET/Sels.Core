...
{
    /// <summary>
    /// Wrapper of a <see cref="List{T}"/> that offers different methods of equality.
    /// </summary>
    /// <typeparam name="T">Type of the objects in the list</typeparam>
    public class EqualityList<T> : List<T>
    {
        // Fields
        private readonly EqualityType _type;
        private readonly StringType _stringType;

        /// <inheritdoc cref="EqualityList{T}"/>
        /// <param name="type"><inheritdoc cref="EqualityType"/></param>
        /// <param name="stringType"><inheritdoc cref="StringType"/></param>
        public EqualityList(EqualityType type = EqualityType.Default, StringType stringType = StringType.Default)
        {
            _type = type;
        ...
        /// <param name="type"><inheritdoc cref="EqualityType"/></param>
        /// <param name="stringType"><inheritdoc cref="StringType"/></param>
        public EqualityList(int capacity, EqualityType type = EqualityType.Default, StringType stringType = StringType.Default) : base(capacity)
        {
            _type = type;
            _stringType = stringType;
        }
        ...
        /// <param name="type"><inheritdoc cref="EqualityType"/></param>
        /// <param name="stringType"><inheritdoc cref="StringType"/></param>
        public EqualityList(IEnumerable<T> collection, EqualityType type = EqualityType.Default, StringType stringType = StringType.Default) : base(collection)
        {
            _type = type;
            _stringType = stringType;
        }
