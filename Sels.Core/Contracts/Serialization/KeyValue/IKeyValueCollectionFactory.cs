...
namespace Sels.Core.Contracts.Serialization.KeyValue
{
    ...
    public interface IKeyValueCollectionFactory
    {
        ...
        object CreateCollection(Type collectionType, IEnumerable<object> deserializedItems, object factoryArgument = null);
        ...
        string[] ParseItems(IEnumerable<string> serializedItems, object factoryArgument = null);
    }
}
