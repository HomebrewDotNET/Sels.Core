...
namespace Sels.Core.Data.SQL.Query.Expressions
{
    ...
    public interface IColumnExpression : IObjectExpression
    {
        ...
        public void ToSql(StringBuilder builder, Func<object, string?> datasetConverterer, Func<string, string>? columnConverter, bool includeAlias = true, QueryBuilderOptions options = QueryBuilderOptions.None);
    }
}
