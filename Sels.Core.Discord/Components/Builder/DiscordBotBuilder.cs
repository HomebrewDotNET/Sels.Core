...
namespace Sels.Core.Discord.Components.Builder
{
    ...
    public class DiscordBotBuilder :  IDiscordBotBuilder
    {
        ...
        public IDiscordBotMessageHandlerBuilder<TMessage> OnMessageReceived<TMessage>(Delegates.Async.AsyncAction<IDiscordBot, TMessage> action) where TMessage : SocketMessage
        {
